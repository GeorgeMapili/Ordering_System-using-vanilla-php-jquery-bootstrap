        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                if (isset($_POST['accept'])) {
                    ...
                    $sql = "UPDATE orders SET o_status = :status WHERE o_id = :id";
                    $statement = $con->prepare($sql);
                    $statement->bindParam(":status", $accepted, PDO::PARAM_STR);
                ...
                <h1 class="text-center display-1 mt-5">PENDING ORDER</h1>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="pending-order.php" method="post">
                                        <input type="hidden" name="id" value="<?= $orders['o_id']; ?>">
