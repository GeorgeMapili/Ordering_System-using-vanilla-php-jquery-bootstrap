    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <h1 class="text-center display-1 mt-5">CANCELLED ORDER</h1>
                ...
                <table class="table table-hover">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col">Cancelled Order</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        $statement->bindParam(":status", $statusCancelled, PDO::PARAM_STR);
                        $statement->execute();

                        while ($cancelOrder = $statement->fetch(PDO::FETCH_ASSOC)) :
                        ?>
                            <tr>
                                <th scope="row"><?= $cancelOrder['o_id']; ?></th>
                                <td><?= $cancelOrder['o_user_name']; ?></td>
                                <td><?= $cancelOrder['o_user_email']; ?></td>
                                <td><?= $cancelOrder['o_user_phone']; ?></td>
                                <td><?= $cancelOrder['o_user_address']; ?></td>
                                <td><?= $cancelOrder['o_user_paymentmode']; ?></td>
                                <td><?= $cancelOrder['o_user_food']; ?></td>
                                <td>₱ <?= $cancelOrder['o_user_totalprice']; ?></td>
                                <td><a class="btn btn-danger disabled">Cancelled</a></td>
                            </tr>
                        <?php endwhile; ?>
